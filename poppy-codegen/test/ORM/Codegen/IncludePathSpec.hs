...
module ORM.Codegen.IncludePathSpec
  ( includePathSpec,
    fourLevelPathSpec,
  )
where
...
import ORM.Codegen.Spec.ShelfDeep (shelfDeepSchema)
import Test.Hspec

includePathSpec :: Spec
includePathSpec =
  describe "ORM.Codegen.IncludePath" $ do
...
fourLevelPathSpec =
  describe "ORM.Codegen.IncludePath four-level fixture" $ do
